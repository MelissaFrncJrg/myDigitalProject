<template>
  <div class="p-8 max-w-5xl mx-auto">
    ...
    <div v-else-if="projects.length === 0" class="text-center text-gray-400">Aucun projet pour l'instant</div>
            ...
            <template #body>
              <div class="space-y-4">
                <p class="text-gray-300">
                  ...
                  <br>Cette action est <span class="text-red-500 font-semibold">irréversible</span>.
                </p>
...
const { createProject, updateProject, getMyProjects, deleteProject, loading } = useProjectService()
