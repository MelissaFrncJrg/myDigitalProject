...
const schema = v.object({
  title: v.pipe(v.string(), v.minLength(3, 'Le titre doit contenir au moins 3 caractères')),
  description: v.pipe(v.string(), v.minLength(10, 'La description est trop courte')),
  status: v.string()
})
